...
>(({ className, ...props }, ref) => (
	<AlertDialog.Portal>
		...
		<AlertDialog.Content
			...
			{...props}
			className={cn(
				'fixed top-[50%] left-[50%] h-[195px] w-[90vw] max-w-[595px] translate-x-[-50%] translate-y-[-50%] bg-linear-to-bl from-[-9%] from-lavender to-109% to-light-blue p-[25px] drop-shadow-lg focus:outline-hidden data-[state=open]:animate-overlayShow',
				className
			)}
		/>
	</AlertDialog.Portal>
